...
static const struct ud_itab_entry ie_invalid = { UD_Iinvalid, O_NONE, O_NONE, O_NONE, P_none };
static const struct ud_itab_entry ie_pause   = { UD_Ipause,   O_NONE, O_NONE, O_NONE, P_none };
static const struct ud_itab_entry ie_nop     = { UD_Inop,     O_NONE, O_NONE, O_NONE, P_none };
...
static uint8_t resolve_operand_size( const struct ud * u, uint8_t s )
{
    switch ( s ) 
    {
    case SZ_V:
 ...
 */
static enum ud_type 
decode_gpr(register struct ud* u, uint8_t s, unsigned char rm)
{
 ...
 */
static void 
decode_imm(struct ud* u, uint8_t s, struct ud_operand *op)
{
 ...
 */
static void 
decode_o(struct ud* u, uint8_t s, struct ud_operand *op)
{
  switch (u->adr_mode) {
    case 64:
        op->offset = 64; 
 ...
 * =============================================================================
 */
unsigned int __stdcall ud_decode( struct ud* u )
{
  inp_start(u);
